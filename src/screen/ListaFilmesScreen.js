...
export default class ListaFilmesScreen extends Component {
  ...
  LocalizarOrdenado(ordenacao) {
    this.setState({ orderBy: ordenacao });
    this.Localizar(ordenacao);
  }
      ...
      <View style={styles.container}>
        ...
        <Picker
          ...
          onValueChange={(itemValue, itemIndex) =>
            this.LocalizarOrdenado(itemValue)
          }>
          ...
          <View style={styles.modal}>
            ...
            <View style={styles.areaInput}>
              <TextInput style={styles.inputText}
                ...
                onChangeText={(valor) => this.setState({ descricao: valor })} value={this.state.descricao}></TextInput>
            </View>
